...
/**
 * @Name: MimeTypeFactory
 * @Description: TODO
 * @Author: tomax
 * @Date: 2019-04-05 10:40
 * @Version: 1.0
 */
public class MimeType {
    private final static Map<String, String> mimeTypes = new ConcurrentHashMap<String, String>(){{
        ...
        put("gz", "applicatoin/x-gzip");
        put("h", "text/plain");
        put("hdf", "application/x-hdf");
        put("hlp", "application/winhlp");
        put("hqx", "application/max-binhex40");
        ...
        put("ml3", "application/x-msmediaview");
        put("ml4", "application/x-msmediaview");
        ...
        put("p7r", "application/x-pkcs7-certeqresp");
        ...
        put("pma", "application/x-perform");
        put("pmc", "application/x-perform");
        put("pml", "application/x-perform");
        put("pmr", "application/x-perform");
        put("pmw", "application/x-perform");
        ...
        put("sv4src", "application/x0sv4crc");
    ...
    public static String getMimeType(String postfix) {
        String mimeType = mimeTypes.get(postfix.toLowerCase());
        return mimeType != null ? mimeType : getMimeType("*");
    }
}
